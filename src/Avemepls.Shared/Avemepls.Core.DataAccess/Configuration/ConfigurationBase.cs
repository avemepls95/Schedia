...
public abstract class ConfigurationBase<TEntity, TId, TType> : IEntityTypeConfiguration<TEntity>
    where TEntity : class, IHasId<TId, TType>
    where TId : struct, IHasValue<TType>
{
    ...
    public void Configure(EntityTypeBuilder<TEntity> builder)
    {
        ...
        builder.Property(t => t.Id)
            .HasConversion(id => id.Value, value => new TId { Value = value });
