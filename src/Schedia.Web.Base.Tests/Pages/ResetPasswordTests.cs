...
{
    private readonly BlazorTestContext<Base.Pages.ResetPassword.ResetPassword> _ctx;

    public ResetPasswordTests()
    {
        _ctx = new BlazorTestContext<Base.Pages.ResetPassword.ResetPassword>();
    ...
    public void ResetPassword_WithToken_ShouldRenderForm()
    {
        ...
        var cut = _ctx.RenderComponent<Schedia.Web.Base.Pages.ResetPassword.ResetPassword>();
