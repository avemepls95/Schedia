...
{
    private readonly BlazorTestContext<Base.Pages.ConfirmEmail.ConfirmEmail> _ctx = new();
    ...
    public void ConfirmEmail_Initially_ShouldShowLoadingState()
    {
        ...
        // Act
        var cut = _ctx.RenderComponent<Schedia.Web.Base.Pages.ConfirmEmail.ConfirmEmail>();
